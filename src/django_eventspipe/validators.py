...
def event_validator(value) -> None:
    """
    Validate an event's json
    """
    try:
        value["name"]
...
# crontab validators from django-celery-beat
# original code: https://github.com/celery/django-celery-beat/blob/main/django_celery_beat/validators.py
